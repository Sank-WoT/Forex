namespace Client
{
    ...
    {
<<<<<<< HEAD
        string Reqest = "http://myfirstphpapp-skro.rhcloud.com/get_currency.php?time=" + poslT + "&limit=" + limit + "&sign=" + value;
        Console.WriteLine(Reqest);
        var webReq = WebRequest.Create(Reqest); // запрос на сайт 
=======
